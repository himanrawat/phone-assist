    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-md rounded-lg bg-card p-6 shadow-lg">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button onClick={onClose} className="rounded p-1 hover:bg-muted"><XIcon className="size-5" /></button>
        </div>
        <form onSubmit={(e) => { e.preventDefault(); mutation.mutate(); }} className="space-y-4">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="input-field pl-9" placeholder="team@example.com" required />
            </div>
          </div>
          <div className="space-y-1">
          ...
          {mutation.isError && <p className="text-sm text-destructive">Failed to send invitation</p>}
